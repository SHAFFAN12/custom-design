...
import Image from '../assets/keagan-henman-Won79_9oUEk-unsplash.jpg';
  ...
  return (
    <div className="login-form flex justify-center items-center h-screen">
      ...
      {user ? (
        ...
        <form className="bg-transparent p-4 rounded shadow-md h-[500px] w-[400px]">
          ...
          <div className="mb-4">
            {isSignUp ? (
              <button
                type="button"
                className="bg-[#252243] text-white px-4 py-2 rounded"
          ...
          <p className="text-center">
            ...
            <span
              className="text-[#252243] cursor-pointer ml-1"
              onClick={() => {
